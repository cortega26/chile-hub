...
| :--- | :--- | :--- | :--- | :--- | :--- | ---: | :--- |
| `regiones` | BCN ArcGIS | `live` | `bcn_arcgis` | `2026-09-26T13:51:37.964851+00:00` | `fresh (0.16h / 2160h)` | 0 | `open-attribution` |
| `provincias` | BCN ArcGIS | `live` | `bcn_arcgis` | `2026-09-26T13:51:37.964851+00:00` | `fresh (0.16h / 2160h)` | 0 | `open-attribution` |
| `comunas` | BCN ArcGIS | `live` | `bcn_arcgis` | `2026-09-26T13:51:37.964851+00:00` | `fresh (0.16h / 2160h)` | 0 | `open-attribution` |
| `comunas_enriquecidas` | BCN ArcGIS | `live` | `bcn_arcgis` | `2026-09-26T13:51:37.964851+00:00` | `fresh (0.16h / 2160h)` | 0 | `open-attribution` |
| `indicadores` | Banco Central de Chile (via mindicador.cl) | `live` | `public_api_with_published_backfill` | `2026-09-26T14:00:34.421059+00:00` | `fresh (0.01h / 72h)` | 1 | `open-attribution` |
| `censo_comunal` | Instituto Nacional de Estadisticas - Censo 2024 | `live` | `official_xlsx` | `2026-09-26T13:51:45.413534+00:00` | `fresh (0.15h / 87600h)` | 0 | `open-attribution` |
| `establecimientos_salud` | Ministerio de Salud - Establecimientos de Salud | `live` | `datos_gob_csv` | `2026-09-26T13:51:50.977412+00:00` | `fresh (0.15h / 1080h)` | 0 | `open-attribution` |
| `establecimientos_educacionales` | Ministerio de Educación - Directorio Oficial de Establecimientos | `live` | `mineduc_datos_abiertos_rar` | `2026-09-26T13:51:53.190748+00:00` | `fresh (0.15h / 8760h)` | 0 | `open-attribution` |
| `censo_hogares_viviendas` | Instituto Nacional de Estadisticas - Censo 2024 | `live` | `official_xlsx` | `2026-09-26T13:51:49.363841+00:00` | `fresh (0.15h / 87600h)` | 0 | `open-attribution` |
| `distritos_electorales` | BCN / Biblioteca del Congreso Nacional de Chile | `live` | `bcn_electoral_mapping_generated` | `2026-09-26T13:51:51.163896+00:00` | `fresh (0.15h / 87600h)` | 0 | `open-attribution` |
| `finanzas_municipales` | SINIM - SUBDERE | `monthly` | `curated_fallback_pending_direct_export` | `2026-09-01T03:04:24.987281+00:00` | `fresh (610.94h / 8760h)` | 0 | `public-api-review-terms` |
| `resultados_educacionales` | Centro de Estudios MINEDUC - Rendimiento 2024 | `live` | `mineduc_rendimiento_2024_rar_agregado_por_comuna` | `2026-09-26T13:52:02.313935+00:00` | `fresh (0.15h / 8760h)` | 0 | `open-attribution` |
| `indicadores_urbanos_siedu` | INE - Sistema de Indicadores y Estándares de Desarrollo Urbano | `live` | `ine_siedu_xlsm_cinco_mediciones_2018_2022` | `2026-09-26T13:52:05.263343+00:00` | `fresh (0.15h / 8760h)` | 1 | `open-attribution` |
| `perfil_territorial_comunal` | chile-hub | `live` | `derived_from_validated_chile_hub_layers` | `2026-09-26T14:01:02.242800+00:00` | `fresh (0.0h / 1080h)` | 0 | `open-attribution` |
| `empresas` | Ministerio de Economia, Fomento y Turismo - Registro de Empresas y Sociedades (RES) | `live` | `datos_gob_cl_ckan_api` | `2026-09-26T14:00:39.370167+00:00` | `fresh (0.01h / 1080h)` | 1 | `open-attribution` |
| `pobreza_comunal` | Observatorio Social — Ministerio de Desarrollo Social y Familia | `live` | `Estimaciones de Pobreza Comunal vía SAE desde encuesta CASEN` | `2026-09-26T13:52:36.350360+00:00` | `fresh (0.14h / 175200h)` | 1 | `open-attribution` |
| `consumo_electrico_comunal` | CNE — Energía Abierta | `fallback` | `Consumo eléctrico anual por comuna y tipo de cliente` | `2026-09-26T13:52:41.326128+00:00` | `fresh (0.14h / 17520h)` | 3 | `open-attribution` |
| `partidos_politicos` | Cámara de Diputadas y Diputados (datos abiertos) + SERVEL | `live` | `WSComun.asmx/retornarPartidosPoliticos + servel.cl/partidos-politicos (estado legal)` | `2026-09-26T13:52:45.780119+00:00` | `fresh (0.14h / 87600h)` | 1 | `open-attribution` |
| `autoridades_electas` | Cámara de Diputadas y Diputados + Senado de Chile | `live` | `WSDiputado.asmx/retornarDiputadosPeriodoActual + camara.cl + senado.cl (Scrapling)` | `2026-09-26T13:54:34.485049+00:00` | `fresh (0.11h / 87600h)` | 0 | `open-attribution` |
| `estadisticas_vitales` | Instituto Nacional de Estadísticas (INE) — Estadísticas Vitales | `live` | `Anuarios de Estadísticas Vitales (tabulados XLSX, tabla 1.2.2-04 por comuna de residencia). Solo definitivos: los boletines provisionales del INE no publican desglose comunal.` | `2026-09-26T13:54:15.452146+00:00` | `fresh (0.11h / 8760h)` | 0 | `open-attribution` |
| `permisos_edificacion` | MINVU — Centro de Estudios de Ciudad y Territorio (CEDOC) | `monthly` | `Viviendas en unidades y superficie (m2) por comuna y año, serie desde 2002 (MINVU CEDOC, en base a permisos otorgados por las Direcciones de Obras Municipales e INE).` | `2026-09-25T19:08:42+00:00` | `fresh (18.87h / 1080h)` | 0 | `open-attribution` |
| `calidad_aire` | SINCA — Ministerio del Medio Ambiente | `live` | `Promedios diarios por estación y contaminante (MP2.5, MP10, SO2, NO2, CO, O3) desde el JSON del SINCA. Cobertura parcial por diseño (~65 comunas con estación). Serie incremental desde la primera cosecha.` | `2026-09-26T13:54:27.688083+00:00` | `fresh (0.11h / 72h)` | 1 | `public-api-review-terms` |
...
- `refreshed_at_utc`: `2026-09-26T13:51:37.964851+00:00`
...
- `refreshed_at_utc`: `2026-09-26T14:00:34.421059+00:00`
...
- `refreshed_at_utc`: `2026-09-26T13:51:45.413534+00:00`
...
- `refreshed_at_utc`: `2026-09-26T13:51:50.977412+00:00`
...
- `refreshed_at_utc`: `2026-09-26T13:51:53.190748+00:00`
...
- `source_mode`: `live`
- `source_detail`: `official_xlsx`
- `refreshed_at_utc`: `2026-09-26T13:51:49.363841+00:00`
- `freshness`: `fresh (0.15h / 87600h)`
- `warning_count`: `0`
- `diagnostic_summary`: Sin observaciones operativas.
- `reuse_status`: `open-attribution`
...
- `refreshed_at_utc`: `2026-09-26T13:51:51.163896+00:00`
- `freshness`: `fresh (0.15h / 87600h)`
- `warning_count`: `0`
- `diagnostic_summary`: Sin observaciones operativas.
- `reuse_status`: `open-attribution`
...
- `refreshed_at_utc`: `2026-09-26T13:52:02.313935+00:00`
- `freshness`: `fresh (0.15h / 8760h)`
- `warning_count`: `0`
...
- `refreshed_at_utc`: `2026-09-26T13:52:05.263343+00:00`
- `freshness`: `fresh (0.15h / 8760h)`
- `warning_count`: `1`
...
- `refreshed_at_utc`: `2026-09-26T14:01:02.242800+00:00`
...
- `refreshed_at_utc`: `2026-09-26T14:00:39.370167+00:00`
...
- `refreshed_at_utc`: `2026-09-26T13:52:36.350360+00:00`
- `freshness`: `fresh (0.14h / 175200h)`
- `warning_count`: `1`
...
- `refreshed_at_utc`: `2026-09-26T13:52:41.326128+00:00`
- `freshness`: `fresh (0.14h / 17520h)`
- `warning_count`: `3`
...
- `refreshed_at_utc`: `2026-09-26T13:52:45.780119+00:00`
- `freshness`: `fresh (0.14h / 87600h)`
- `warning_count`: `1`
...
- `refreshed_at_utc`: `2026-09-26T13:54:34.485049+00:00`
- `freshness`: `fresh (0.11h / 87600h)`
- `warning_count`: `0`
...
- `source_mode`: `live`
- `source_detail`: `Anuarios de Estadísticas Vitales (tabulados XLSX, tabla 1.2.2-04 por comuna de residencia). Solo definitivos: los boletines provisionales del INE no publican desglose comunal.`
- `refreshed_at_utc`: `2026-09-26T13:54:15.452146+00:00`
- `freshness`: `fresh (0.11h / 8760h)`
- `warning_count`: `0`
- `diagnostic_summary`: 2010: 692 filas desde 'Anuario de estadísticas vitales 2010' (hoja 122-04; TOTAL país: 250643 nacimientos, 97930 defunciones)
- `reuse_status`: `open-attribution`
...
- `source_mode`: `monthly`
- `source_detail`: `Viviendas en unidades y superficie (m2) por comuna y año, serie desde 2002 (MINVU CEDOC, en base a permisos otorgados por las Direcciones de Obras Municipales e INE).`
- `refreshed_at_utc`: `2026-09-25T19:08:42+00:00`
- `freshness`: `fresh (18.87h / 1080h)`
- `warning_count`: `0`
- `diagnostic_summary`: descubrimiento: repositorio-biblionumber
- `reuse_status`: `open-attribution`
...
- `source_mode`: `live`
- `source_detail`: `Promedios diarios por estación y contaminante (MP2.5, MP10, SO2, NO2, CO, O3) desde el JSON del SINCA. Cobertura parcial por diseño (~65 comunas con estación). Serie incremental desde la primera cosecha.`
- `refreshed_at_utc`: `2026-09-26T13:54:27.688083+00:00`
- `freshness`: `fresh (0.11h / 72h)`
- `warning_count`: `1`
