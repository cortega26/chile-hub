...
| :--- | :--- | :--- | :--- | :--- | :--- | ---: | :--- | :--- |
| `comunas` | BCN ArcGIS | `live` | `bcn_arcgis` | `fresh (0.82h / 2160h)` | `full` | 346 | `ok` | none |
| `comunas_enriquecidas` | BCN ArcGIS | `live` | `bcn_arcgis` | `fresh (0.82h / 2160h)` | `full` | 346 | `ok` | none |
| `indicadores` | Banco Central de Chile (via mindicador.cl) | `live` | `public_api_with_published_backfill` | `fresh (0.82h / 72h)` | `not_applicable` | 426 | `ok` | indicadores live refresh reused last published artifact for missing codes: ipc |
| `provincias` | BCN ArcGIS | `live` | `bcn_arcgis` | `fresh (0.82h / 2160h)` | `full` | 56 | `ok` | none |
| `regiones` | BCN ArcGIS | `live` | `bcn_arcgis` | `fresh (0.82h / 2160h)` | `full` | 16 | `ok` | none |
