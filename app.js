...
function renderCatalog(bundle) {
    ...
    const CATEGORIES = {
        ...
        demografia: {
            ...
            datasets: ["censo_comunal", "censo_hogares_viviendas", "finanzas_municipales", "resultados_educacionales", "indicadores_urbanos_siedu", "consumo_electrico_comunal", "pobreza_comunal", "estadisticas_vitales"]
        },
        directorios: {
