...
│   │   ├── estadisticas_vitales_extractor.py             Estadísticas vitales comunales — nacimientos y defunciones (INE) → data/staging/
...
│   ├── build_dev_db.py            Orquestador (1 034 líneas): main() + fases (_load_inputs, _compute_validations, _write_data_artifacts, _generate_reports)
...
- `build_dev_db.py` (1 034 líneas) y `src/chile_hub/core.py` (1 995 líneas) — usar estas áncoras:
