...
| 095 | [Floor Python `>=3.11` + despineo pandas](095-python-311-floor.md) | P1 | M | LOW | — | DONE (2026-09-15, commit 79fde6a — floor, pandas sin marcador, matriz sin 3.10, lock solo-sustracciones, test matriz actualizado; branch advisor/wave-3) |
...
| 097 | [Docs quirúrgicos: counts, badge, §5 como puntero](097-docs-surgical-fixes.md) | P1 | S | LOW | — | DONE (2026-09-15, commit e99cac5 — CLAUDE counts+lanes, convención 22/21/20/25/28 documentada, criterios como fuente única; branch advisor/wave-4) |
| 098 | [Arquitectura docs + anti-drift extendido](098-docs-architecture.md) | P2 | M | MED | 097 | DONE (2026-09-15, commit eeeec8e — glosario estado↔carril, CLAUDE ~35 líneas, conteos solo en AGENTS, gate --docs ×3 + regex fix + tests; branch advisor/wave-4) |
