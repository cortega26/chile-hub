...
│   ├── dataset_specs/               DatasetSpec cohort Phase 3A (10 specs: piloto + 9 direct stable) — proyección shadow en _shared.py/reports.py
...
| `test_phase2_datasetspec.py` | No | DatasetSpec piloto Phase 2–3A: modelo tipado, proyecciones de compatibilidad contra catálogo/registry/contrato legacy, overlay y fallos cerrados (10 specs) |
...
| Hechos operacionales del piloto DatasetSpec (Phase 2–3A cohort) | `data/dataset_specs/` (10 specs) — proyección shadow en `_shared.py`/`reports.py` | `tests/test_phase2_datasetspec.py` (equivalencia vs. catálogo/registry/contrato legacy, 24 tests) |
