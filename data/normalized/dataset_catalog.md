...
| `indicadores` | Banco Central de Chile (via mindicador.cl) | `live` | `fresh (0.02h / 72h)` | `open-attribution (Reproducción libre con citación (BCCh / INE))` | 514 | `Tier A/B` | `fecha, codigo_indicador` | `ok` |
...
| `establecimientos_salud` | Ministerio de Salud - Establecimientos de Salud | `live` | `fresh (0.02h / 1080h)` | `open-attribution (CC0)` | 5707 | `Tier A` | `codigo_establecimiento, codigo_comuna` | `ok` |
...
| `finanzas_municipales` | SINIM - SUBDERE | `monthly` | `fresh (447.64h / 8760h)` | `public-api-review-terms (Datos públicos municipales; términos de reutilización sujetos a revisión)` | 345 | `Tier B` | `anio, codigo_comuna` | `ok` |
...
| `empresas` | Ministerio de Economia, Fomento y Turismo - Registro de Empresas y Sociedades (RES) | `live` | `fresh (0.01h / 1080h)` | `open-attribution (CC-BY)` | 1572116 | `Tier B` | `rut` | `ok` |
