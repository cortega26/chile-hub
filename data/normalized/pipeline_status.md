...
| `indicadores` | Banco Central de Chile (via mindicador.cl) | `live` | `public_api_with_published_backfill` | `fresh (0.0h / 72h)` | `not_applicable` | 427 | `ok` | indicadores live refresh reused last published artifact for missing codes: ipc |
