...
│   ├── registry/                  DatasetSpec cohort Phase 2–3A (ADR-018): modelo tipado + proyecciones de compatibilidad (dataset_spec.py, 585 líneas)
...
│   ├── dataset_specs/               DatasetSpec cohort Phase 3A–3B (13 specs: piloto + 12 direct stable) — proyección shadow en _shared.py/reports.py
...
| `test_phase2_datasetspec.py` | No | DatasetSpec piloto Phase 2–3A: modelo tipado, proyecciones de compatibilidad contra catálogo/registry/contrato legacy, overlay y fallos cerrados (13 specs) |
...
| Hechos operacionales del piloto DatasetSpec (Phase 2–3A cohort) | `data/dataset_specs/` (13 specs) — proyección shadow en `_shared.py`/`reports.py` | `tests/test_phase2_datasetspec.py` (equivalencia vs. catálogo/registry/contrato legacy, 24 tests) |
