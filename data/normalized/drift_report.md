...
- `degradation`: indicadores live refresh reused last published artifact for missing codes: ipc; indicadores freshness is stale: 229.19h since refresh, policy max is 72h
- `warning_count`: `2`
