...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `regiones` | BCN ArcGIS | `live` | `bcn_arcgis` | `2026-06-01T15:38:12.156192+00:00` | `fresh (0.01h / 2160h)` | `open-attribution` |
| `provincias` | BCN ArcGIS | `live` | `bcn_arcgis` | `2026-06-01T15:38:12.156192+00:00` | `fresh (0.01h / 2160h)` | `open-attribution` |
| `comunas` | BCN ArcGIS | `live` | `bcn_arcgis` | `2026-06-01T15:38:12.156192+00:00` | `fresh (0.01h / 2160h)` | `open-attribution` |
| `indicadores` | Banco Central de Chile (via mindicador.cl) | `live` | `public_api` | `2026-06-01T15:38:37.668778+00:00` | `fresh (0.0h / 72h)` | `open-attribution` |
