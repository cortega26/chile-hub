...
| :--- | :--- | :--- | :--- | :--- | :--- | ---: | :--- |
| `regiones` | BCN ArcGIS | `live` | `bcn_arcgis` | `2026-06-17T16:50:40.866524+00:00` | `fresh (23.53h / 2160h)` | 0 | `open-attribution` |
| `provincias` | BCN ArcGIS | `live` | `bcn_arcgis` | `2026-06-17T16:50:40.866524+00:00` | `fresh (23.53h / 2160h)` | 0 | `open-attribution` |
| `comunas` | BCN ArcGIS | `live` | `bcn_arcgis` | `2026-06-17T16:50:40.866524+00:00` | `fresh (23.53h / 2160h)` | 0 | `open-attribution` |
| `comunas_enriquecidas` | BCN ArcGIS | `live` | `bcn_arcgis` | `2026-06-17T16:50:40.866524+00:00` | `fresh (23.53h / 2160h)` | 0 | `open-attribution` |
| `indicadores` | Banco Central de Chile (via mindicador.cl) | `live` | `public_api_with_published_backfill` | `2026-06-17T16:51:18.423894+00:00` | `fresh (23.52h / 72h)` | 2 | `open-attribution` |
| `censo_comunal` | Instituto Nacional de Estadisticas - Censo 2024 | `live` | `official_xlsx` | `2026-06-17T16:51:19.142622+00:00` | `fresh (23.52h / 87600h)` | 0 | `open-attribution` |
| `establecimientos_salud` | Ministerio de Salud - Establecimientos de Salud | `live` | `datos_gob_csv` | `2026-06-17T16:51:24.593612+00:00` | `fresh (23.51h / 1080h)` | 0 | `open-attribution` |
| `establecimientos_educacionales` | Ministerio de Educación - Directorio Oficial de Establecimientos | `live` | `mineduc_datos_abiertos_rar` | `2026-06-17T16:51:25.318310+00:00` | `fresh (23.51h / 8760h)` | 0 | `open-attribution` |
| `censo_hogares_viviendas` | Instituto Nacional de Estadisticas - Censo 2024 | `live` | `official_xlsx` | `2026-06-17T16:51:19.609225+00:00` | `fresh (23.52h / 87600h)` | 0 | `open-attribution` |
| `distritos_electorales` | BCN / Biblioteca del Congreso Nacional de Chile | `live` | `bcn_electoral_mapping_generated` | `2026-06-17T16:51:24.727935+00:00` | `fresh (23.51h / 87600h)` | 0 | `open-attribution` |
| `finanzas_municipales` | SINIM - SUBDERE | `fallback` | `curated_fallback_pending_direct_export` | `2026-06-17T16:51:25.710419+00:00` | `fresh (23.51h / 8760h)` | 1 | `public-api-review-terms` |
| `resultados_educacionales` | Centro de Estudios MINEDUC - Datos Abiertos | `fallback` | `curated_fallback_comuna_year_aggregation` | `2026-06-17T16:51:28.239977+00:00` | `fresh (23.51h / 8760h)` | 1 | `open-attribution` |
| `indicadores_urbanos_siedu` | INE - Sistema de Indicadores y Estándares de Desarrollo Urbano | `fallback` | `curated_fallback_partial_urban_coverage` | `2026-06-17T16:51:29.383250+00:00` | `fresh (23.51h / 8760h)` | 2 | `open-attribution` |
| `perfil_territorial_comunal` | chile-hub | `fallback` | `derived_from_validated_chile_hub_layers` | `2026-06-18T16:22:16.897775+00:00` | `fresh (0.0h / 1080h)` | 0 | `open-attribution` |
| `empresas` | Ministerio de Economia, Fomento y Turismo - Registro de Empresas y Sociedades (RES) | `live` | `datos_gob_cl_ckan_api` | `2026-06-18T15:12:32.375088+00:00` | `fresh (1.16h / 1080h)` | 3 | `open-attribution` |
...
- `refreshed_at_utc`: `2026-06-18T16:22:16.897775+00:00`
