...
│   ├── build_dev_db.py            Orquestador (946 líneas): main() + fases (_load_inputs, _compute_validations, _write_data_artifacts, _generate_reports)
...
- `build_dev_db.py` (946 líneas) y `src/chile_hub/core.py` (1 995 líneas) — usar estas áncoras:
