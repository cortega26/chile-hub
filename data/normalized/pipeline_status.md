...
| `indicadores` | Banco Central de Chile (via mindicador.cl) | `live` | `public_api_with_published_backfill` | `fresh (0.07h / 72h)` | `not_applicable` | 444 | `ok` | indicadores live refresh reused last published artifact for missing codes: ipc |
