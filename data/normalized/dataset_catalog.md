...
- `generated_at_utc`: `2026-09-15T11:57:40.284582+00:00`
- `dataset_count`: `22`

| Dataset | Source | Mode | Freshness | Reuse | Records | Confidence | Join Keys | Validation |
| :--- | :--- | :--- | :--- | :--- | ---: | :--- | :--- | :--- |
| `regiones` | BCN ArcGIS | `live` | `fresh (832.25h / 2160h)` | `open-attribution (CC BY)` | 16 | `Tier B` | `codigo_region` | `ok` |
| `provincias` | BCN ArcGIS | `live` | `fresh (832.25h / 2160h)` | `open-attribution (CC BY)` | 56 | `Tier B` | `codigo_provincia, codigo_region` | `ok` |
| `comunas` | BCN ArcGIS | `live` | `fresh (832.25h / 2160h)` | `open-attribution (CC BY)` | 346 | `Tier B` | `codigo_comuna, codigo_region` | `ok` |
| `comunas_enriquecidas` | BCN ArcGIS | `live` | `fresh (832.25h / 2160h)` | `open-attribution (CC BY)` | 346 | `Tier B` | `codigo_comuna` | `ok` |
| `indicadores` | Banco Central de Chile (via mindicador.cl) | `live` | `stale (787.59h / 72h)` | `open-attribution (Reproducción libre con citación (BCCh / INE))` | 573 | `Tier A/B` | `fecha, codigo_indicador` | `ok` |
| `censo_comunal` | Instituto Nacional de Estadisticas - Censo 2024 | `live` | `fresh (832.25h / 87600h)` | `open-attribution (CC BY 4.0)` | 346 | `Tier A` | `codigo_comuna, codigo_region` | `ok` |
| `establecimientos_salud` | Ministerio de Salud - Establecimientos de Salud | `live` | `fresh (832.25h / 1080h)` | `open-attribution (CC0)` | 5717 | `Tier A` | `codigo_establecimiento, codigo_comuna` | `ok` |
| `establecimientos_educacionales` | Ministerio de Educación - Directorio Oficial de Establecimientos | `live` | `fresh (832.25h / 8760h)` | `open-attribution (CC-BY-3.0)` | 12898 | `Tier A` | `codigo_comuna` | `ok` |
| `censo_hogares_viviendas` | Instituto Nacional de Estadisticas - Censo 2024 | `live` | `fresh (578.48h / 87600h)` | `open-attribution (CC BY 4.0)` | 346 | `Tier A` | `codigo_comuna, codigo_region` | `ok` |
| `distritos_electorales` | BCN / Biblioteca del Congreso Nacional de Chile | `live` | `fresh (832.25h / 87600h)` | `open-attribution (CC0)` | 346 | `Tier A` | `codigo_comuna` | `ok` |
| `finanzas_municipales` | SINIM - SUBDERE | `monthly` | `fresh (344.89h / 8760h)` | `public-api-review-terms (Datos públicos municipales; términos de reutilización sujetos a revisión)` | 345 | `Tier B` | `anio, codigo_comuna` | `ok` |
| `resultados_educacionales` | Centro de Estudios MINEDUC - Rendimiento 2024 | `live` | `fresh (832.25h / 8760h)` | `open-attribution (CC-BY-3.0)` | 345 | `Tier B` | `anio, codigo_comuna` | `ok` |
| `indicadores_urbanos_siedu` | INE - Sistema de Indicadores y Estándares de Desarrollo Urbano | `live` | `fresh (832.25h / 8760h)` | `open-attribution (Licencia de Datos Abiertos INE)` | 6701 | `Tier B` | `anio, codigo_comuna, codigo_indicador` | `ok` |
...
| `empresas` | Ministerio de Economia, Fomento y Turismo - Registro de Empresas y Sociedades (RES) | `live` | `fresh (832.14h / 1080h)` | `open-attribution (CC-BY)` | 1590979 | `Tier B` | `rut` | `ok` |
| `pobreza_comunal` | Observatorio Social — Ministerio de Desarrollo Social y Familia | `live` | `fresh (832.14h / 175200h)` | `open-attribution (Datos abiertos MDS)` | 690 | `Tier A` | `codigo_comuna, codigo_region` | `ok` |
| `consumo_electrico_comunal` | CNE — Energía Abierta | `fallback` | `fresh (832.14h / 17520h)` | `open-attribution (CC BY)` | 3 | `Tier C` | `codigo_comuna, codigo_region` | `ok` |
| `partidos_politicos` | Cámara de Diputadas y Diputados (datos abiertos) + SERVEL | `live` | `fresh (832.14h / 87600h)` | `open-attribution (CC-BY)` | 36 | `Tier B` | `id_partido` | `ok` |
| `autoridades_electas` | Cámara de Diputadas y Diputados + Senado de Chile | `live` | `fresh (832.12h / 87600h)` | `open-attribution (CC-BY)` | 205 | `Tier B` | `distrito_electoral, circunscripcion_senatorial, codigo_region` | `ok` |
| `estadisticas_vitales` | Instituto Nacional de Estadísticas (INE) — Estadísticas Vitales | `live` | `fresh (11.28h / 8760h)` | `open-attribution (CC BY 4.0)` | 13840 | `Tier A` | `anio, codigo_comuna` | `ok` |
| `permisos_edificacion` | MINVU — Centro de Estudios de Ciudad y Territorio (CEDOC) | `live` | `fresh (11.3h / 1080h)` | `open-attribution (Uso autorizado con cita (MINVU CEDOC))` | 8650 | `Tier A` | `anio, codigo_comuna` | `ok` |
| `calidad_aire` | SINCA — Ministerio del Medio Ambiente | `live` | `fresh (10.79h / 72h)` | `public-api-review-terms (Datos públicos MMA; sin licencia explícita, citar fuente oficial)` | 756 | `Tier B` | `fecha, codigo_comuna, codigo_contaminante` | `ok` |
...
- `indicator_delivery`: `{"dolar": "live", "euro": "live", "ipc": "ine_override", "uf": "live", "utm": "live"}`
...
- `warnings`: indicadores live refresh reused last published artifact for missing codes: ipc; indicadores freshness is stale: 787.59h since refresh, policy max is 72h
...
- `freshness`: `fresh (832.25h / 87600h)`
...
- `source_url`: https://datos.gob.cl/dataset/3bf4cf7c-f638-4735-9a01-f65faae4beca/resource/2c44d782-3365-44e3-aefb-2c8b8363a1bc/download/establecimientos_20260804.csv
- `documentation`: `docs/datasets/establecimientos_salud.md`
- `freshness`: `fresh (832.25h / 1080h)`
...
- `freshness`: `fresh (578.48h / 87600h)`
- `reuse_policy`: `{"status": "open-attribution", "license": "CC BY 4.0", "license_url": "https://www.ine.gob.cl/terminos-de-uso", "attribution_required": true, "redistribution_ok": true, "summary": "Resultados oficiales del Censo 2024 publicados por el INE."}`
...
- `freshness`: `fresh (832.14h / 175200h)`
...
- `freshness`: `fresh (832.14h / 17520h)`
...
- `freshness`: `fresh (832.14h / 87600h)`
...
- `freshness`: `fresh (832.12h / 87600h)`
...
Nacimientos y defunciones por comuna de residencia y sexo, desde los Anuarios de Estadísticas Vitales del INE (definitivos, 2010 en adelante).

- `source_url`: https://www.ine.gob.cl/estadisticas-por-tema/demografia-y-poblacion/estadisticas-vitales
- `documentation`: `docs/datasets/estadisticas_vitales.md`
- `freshness`: `fresh (11.28h / 8760h)`
- `reuse_policy`: `{"status": "open-attribution", "license": "CC BY 4.0", "license_url": "https://www.ine.gob.cl/terminos-de-uso", "attribution_required": true, "redistribution_ok": true, "summary": "Anuarios de Estadísticas Vitales del INE (nacimientos y defunciones por comuna). Datos abiertos con atribución requerida."}`
- `fields`: `anio, codigo_region, codigo_comuna, nombre_comuna, evento, sexo, cantidad, estado_dato, fuente, url_fuente, fecha_fuente`
- `join_keys`: `anio, codigo_comuna`
- `outputs`: `{"parquet": "data/normalized/estadisticas_vitales.parquet", "json": "data/normalized/estadisticas_vitales.json", "duckdb_table": "estadisticas_vitales", "sqlite_table": "estadisticas_vitales", "excel_sheet": "Estadísticas Vitales"}`
- `usage_examples`: `{"python": "from chile_hub import ChileHub\n\nhub = ChileHub()\ndf = hub.load_polars(\"estadisticas_vitales\")\n# Nacimientos por comuna 2023\nnac_2023 = df.filter((pl.col(\"anio\") == 2023) & (pl.col(\"evento\") == \"nacimiento\"))", "duckdb": "SELECT anio, codigo_comuna, sum(cantidad) AS hechos\nFROM 'data/normalized/estadisticas_vitales.parquet'\nWHERE evento = 'nacimiento'\nGROUP BY 1, 2 ORDER BY 1, 3 DESC;", "cli": "chile-hub show estadisticas_vitales"}`
- `warnings`: none
...
Viviendas en unidades y superficie (m2) por comuna y año —casas y departamentos— desde las estadísticas de permisos de edificación del CEDOC (MINVU), serie desde 2002.
...
- `warnings`: none
- `notes`: descubrimiento: repositorio-biblionumber; 8650 filas desde 'minvu_permisos_edificacion_anual_20260915T003946Z.xlsx' (hojas: número_total, m2_total, número_departamentos, m2_departamentos, número_casas, m2_casas; años provisionales: [2024, 2025, 2026])

## calidad_aire

Promedios diarios de contaminantes atmosféricos (MP2.5, MP10, SO2, NO2, CO, O3) por estación de monitoreo, desde el SINCA (MMA). Cobertura parcial: ~65 comunas con estación.

- `source_url`: https://sinca.mma.gob.cl/index.php/json/listadomapa2k19/
- `documentation`: `docs/datasets/calidad_aire.md`
- `freshness`: `fresh (10.79h / 72h)`
- `reuse_policy`: `{"status": "public-api-review-terms", "license": "Datos públicos MMA; sin licencia explícita, citar fuente oficial", "license_url": "https://sinca.mma.gob.cl/", "attribution_required": true, "redistribution_ok": true, "summary": "Mediciones de calidad del aire del SINCA (MMA), API JSON pública. Organismo público chileno sin restricción explícita de reúso; citar fuente oficial."}`
...
- `join_keys`: `fecha, codigo_comuna, codigo_contaminante`
...
- `warnings`: cobertura SINCA: 65/346 comunas (18.8%) — parcial por diseño; solo comunas con estación
- `notes`: inventario: 125 estaciones en el listado; 125 con filas emitidas; 756 filas diarias nuevas desde 'sinca_listadomapa_20260915T011014Z.json'; historial: fusionado con staging existente
