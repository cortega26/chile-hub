...
| `finanzas_municipales` | `drifted` | `live` | `partial` | `none` | 0 | Ninguna. |
...
- `degradation`: indicadores live refresh reused last published artifact for missing codes: ipc; indicadores freshness is stale: 290.34h since refresh, policy max is 72h
- `warning_count`: `2`
