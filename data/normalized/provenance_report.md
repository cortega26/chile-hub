...
- `generated_at_utc`: `2026-06-27T10:43:46.491183+00:00`
- `dataset_count`: `15`
- `live_count`: `13`
- `fallback_count`: `2`
...
| :--- | :--- | :--- | :--- | :--- | :--- | ---: | :--- |
| `regiones` | BCN ArcGIS | `live` | `bcn_arcgis` | `2026-06-27T10:39:27.298086+00:00` | `fresh (0.07h / 2160h)` | 0 | `open-attribution` |
| `provincias` | BCN ArcGIS | `live` | `bcn_arcgis` | `2026-06-27T10:39:27.298086+00:00` | `fresh (0.07h / 2160h)` | 0 | `open-attribution` |
| `comunas` | BCN ArcGIS | `live` | `bcn_arcgis` | `2026-06-27T10:39:27.298086+00:00` | `fresh (0.07h / 2160h)` | 0 | `open-attribution` |
| `comunas_enriquecidas` | BCN ArcGIS | `live` | `bcn_arcgis` | `2026-06-27T10:39:27.298086+00:00` | `fresh (0.07h / 2160h)` | 0 | `open-attribution` |
| `indicadores` | Banco Central de Chile (via mindicador.cl) | `live` | `public_api_with_published_backfill` | `2026-06-27T10:39:31.450957+00:00` | `fresh (0.07h / 72h)` | 1 | `open-attribution` |
| `censo_comunal` | Instituto Nacional de Estadisticas - Censo 2024 | `live` | `official_xlsx` | `2026-06-27T10:39:34.964796+00:00` | `fresh (0.07h / 87600h)` | 0 | `open-attribution` |
| `establecimientos_salud` | Ministerio de Salud - Establecimientos de Salud | `live` | `datos_gob_csv` | `2026-06-27T10:39:38.236253+00:00` | `fresh (0.07h / 1080h)` | 0 | `open-attribution` |
| `establecimientos_educacionales` | Ministerio de Educación - Directorio Oficial de Establecimientos | `live` | `mineduc_datos_abiertos_rar` | `2026-06-27T10:39:41.294873+00:00` | `fresh (0.07h / 8760h)` | 0 | `open-attribution` |
| `censo_hogares_viviendas` | Instituto Nacional de Estadisticas - Censo 2024 | `live` | `official_xlsx` | `2026-06-27T10:39:36.664153+00:00` | `fresh (0.07h / 87600h)` | 0 | `open-attribution` |
| `distritos_electorales` | BCN / Biblioteca del Congreso Nacional de Chile | `live` | `bcn_electoral_mapping_generated` | `2026-06-27T10:39:38.703663+00:00` | `fresh (0.07h / 87600h)` | 0 | `open-attribution` |
| `finanzas_municipales` | SINIM - SUBDERE | `fallback` | `curated_fallback_pending_direct_export` | `2026-06-27T10:39:42.541588+00:00` | `fresh (0.07h / 8760h)` | 1 | `public-api-review-terms` |
| `resultados_educacionales` | Centro de Estudios MINEDUC - Rendimiento 2024 | `live` | `mineduc_rendimiento_2024_rar_agregado_por_comuna` | `2026-06-27T10:39:48.720199+00:00` | `fresh (0.07h / 8760h)` | 0 | `open-attribution` |
| `indicadores_urbanos_siedu` | INE - Sistema de Indicadores y Estándares de Desarrollo Urbano | `live` | `ine_siedu_xlsm_cinco_mediciones_2018_2022` | `2026-06-27T10:39:52.073262+00:00` | `fresh (0.07h / 8760h)` | 1 | `open-attribution` |
| `perfil_territorial_comunal` | chile-hub | `fallback` | `derived_from_validated_chile_hub_layers` | `2026-06-27T10:43:46.488820+00:00` | `fresh (0.0h / 1080h)` | 0 | `open-attribution` |
| `empresas` | Ministerio de Economia, Fomento y Turismo - Registro de Empresas y Sociedades (RES) | `live` | `datos_gob_cl_ckan_api` | `2026-06-27T10:40:12.037840+00:00` | `fresh (0.06h / 1080h)` | 3 | `open-attribution` |
...
- `refreshed_at_utc`: `2026-06-27T10:39:27.298086+00:00`
...
- `refreshed_at_utc`: `2026-06-27T10:39:31.450957+00:00`
...
- `refreshed_at_utc`: `2026-06-27T10:39:34.964796+00:00`
...
- `refreshed_at_utc`: `2026-06-27T10:39:38.236253+00:00`
...
- `refreshed_at_utc`: `2026-06-27T10:39:41.294873+00:00`
...
- `source_mode`: `live`
- `source_detail`: `official_xlsx`
- `refreshed_at_utc`: `2026-06-27T10:39:36.664153+00:00`
- `freshness`: `fresh (0.07h / 87600h)`
- `warning_count`: `0`
- `diagnostic_summary`: Sin observaciones operativas.
- `reuse_status`: `open-attribution`
...
- `refreshed_at_utc`: `2026-06-27T10:39:38.703663+00:00`
- `freshness`: `fresh (0.07h / 87600h)`
- `warning_count`: `0`
- `diagnostic_summary`: Sin observaciones operativas.
- `reuse_status`: `open-attribution`
...
- `refreshed_at_utc`: `2026-06-27T10:39:42.541588+00:00`
- `freshness`: `fresh (0.07h / 8760h)`
- `warning_count`: `1`
...
- `refreshed_at_utc`: `2026-06-27T10:39:48.720199+00:00`
- `freshness`: `fresh (0.07h / 8760h)`
- `warning_count`: `0`
...
- `refreshed_at_utc`: `2026-06-27T10:39:52.073262+00:00`
- `freshness`: `fresh (0.07h / 8760h)`
- `warning_count`: `1`
...
- `refreshed_at_utc`: `2026-06-27T10:43:46.488820+00:00`
...
- `refreshed_at_utc`: `2026-06-27T10:40:12.037840+00:00`
